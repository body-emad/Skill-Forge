  ...
  return (
    <Layout>
      <section className="flex flex-col gap-6 items-center py-8 px-3 min-h-[100vh]">
        ...
        >
          <h1 className="text-center text-black dark:text-purple-500 text-4xl font-bold font-inter">
            Registration Page
          </h1>
          {/* name */}
          <InputBox
          ...
          <div className=" flex flex-col gap-2  ">
            ...
            >
              Avatar{' '}
              <span className="text-primary font-inter text-lg">
                {'('}Optional{')'}
              </span>
            </label>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="mt-2 bg-primary text-white dark:text-base-200 transition-all ease-in-out duration-300 rounded-md py-2 font-nunito-sans font-[500]  text-lg cursor-pointer"
          >
          ...
          <p className="text-center font-inter text-gray-500 dark:text-slate-300">
            ...
            <Link
              to="/login"
              className="link text-secondary font-lato cursor-pointer"
            >
              {' '}
              Login
            </Link>
